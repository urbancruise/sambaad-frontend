...
export default function TaskPage() {
    ...
    return (
        <div className="space-y-8 p-6 sm:p-8 bg-[#f3f4f6] text-slate-800 min-h-screen selection:bg-[#3bc4d9]/20">
            ...
            {!loading && tasks.length === 0 && (
                <div className="bg-white border border-slate-100/80 rounded-3xl p-16 text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                    <div className="mx-auto w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center border border-slate-100 mb-4 text-slate-400">
                        <Layers size={24} />
                    </div>
                    <h2 className="text-lg font-bold text-slate-800 tracking-tight">
                        No Active Nodes Found
                    </h2>
                    <p className="text-slate-500 mt-1 text-sm max-w-sm mx-auto leading-relaxed">
